...
digizeit<- read.csv("data_raw/NAC1.csv", header = FALSE)
t.S<-digizeit[,1]
S<-digizeit[,2]
...
#Output IPD
IPD_01<-matrix(c(t.IPD,event.IPD,arm),ncol=3,byrow=F)

IPD_01

save(IPD_01, file = "data/NAC1.RData")
