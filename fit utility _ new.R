...
solution_u_0 <- optim(par = c(0.001, 0.001, 0.001), fn = utility_0, lower = c(0.84, 0.75, 0.43), upper = c( 0.99, 1, 1),
                      method = "L-BFGS-B" )
solution_u_0
...
solution_u_1 <- optim(par = c(0.01, 0.01, 0.01), fn = utility_1, c(0.84,0.75, 0.5), upper = c( 0.99, 1, 1),
                      method = "L-BFGS-B" )
solution_u_1
...
solution_u_5 <- optim(par = c(0.01, 0.01, 0.01), fn = utility_5, c(0.84,0.75, 0.5), upper = c( 0.99, 1, 1),
                      method = "L-BFGS-B" )
solution_u_5
...
solution_u_10 <- optim(par = c(0.01, 0.01, 0.01), fn = utility_10, c(0.84,0.75, 0.5), upper = c( 0.99, 1, 1),
                       method = "L-BFGS-B" )
solution_u_10
